...
async function main() {
  ...
  const VIDEO_ID = 'RT-C8PeHhGE'
  const title = 'Remarks after issuance of Full Registration'
  const slug = 'remarks-after-issuance-of-full-registration'
...
<p style="margin-bottom:1.25rem;">Watch the remarks delivered by PM Party leadership following the official issuance of the Full Registration certificate by the Office of the Registrar of Political Parties (ORPP) — a defining moment in Kenya's political landscape and the beginning of the Kenyan Renaissance.</p>
...
`,
      excerpt: 'Watch the remarks delivered by PM Party leadership following the official issuance of the Full Registration certificate by the ORPP.',
