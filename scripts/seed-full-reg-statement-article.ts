...
async function main() {
  ...
  const title = 'Statement on Full Registration of PM Party'
  const slug = 'statement-on-full-registration-of-pm-party'
...
<p style="margin-bottom:1.25rem;">PM Party issues an official statement on its full registration by the Office of the Registrar of Political Parties (ORPP) — a historic milestone marking the beginning of the Kenyan Renaissance. Watch the full statement above.</p>
...
`,
      excerpt: 'PM Party issues an official statement on its full registration by the ORPP — a historic milestone marking the beginning of the Kenyan Renaissance.',
